...
pub const SAMPLING_TIME: f64 = 1.0/30.0;
...
pub const AVERAGE_FREQ: usize = 16;
pub const AVERAGE_TIME: usize = 1;
pub const MAX_VERTICES_VISUALS: usize = SAMPLES*4;
pub const MAX_INDICES_VISUALS: usize = SAMPLES*6;
